...
| `polynorm_eval.jsonl` | 278 | Apple PolyNorm-Bench zh-CN 转换(`tn.datagen.polynorm`),27 类跨域,人工复核剔除不合理样本 + 读法政策对齐(电话 1 读幺 / v 不读版本,2026-07-12 拍板;理由见转换器 BLOCKLIST 与政策规则);gold 为 Apple 原标注(读法约定与本项目有差异,以 acceptable 口径为主) |
